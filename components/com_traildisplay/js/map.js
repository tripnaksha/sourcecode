...
function beginRecording() {
	...
	var trailbot = document.getElementById('trailbot');
...
//	  html += "<img onclick=\"STTAFFUNC.cw(this, {id:'2009022410967', link: window.location, title: document.title });\" onmouseover=\"STTAFFUNC.showHoverMap(this, '2009022410967', window.location, document.title)\" onmouseout=\"STTAFFUNC.hideHoverMap(this)\" src=\"http://www.tripnaksha.com//modules/mod_taf/images/tafbutton_red16.png\" alt=\"SocialTwist Tell-a-Friend\"/></a></div>";
...
//	   GEvent.trigger(newma,"click");
	   ...
	   if (trailbot)
	   {
	     trailbot.innerHTML = "<div style='color: #6A8F49; font-size: 1.8em;'><b><h3>Trail Description</h3></b></div>";
	     trailbot.innerHTML = trailbot.innerHTML + intro;
	     trailbot.style.visibility = "visible";
	     trailbot.style.height = "auto";
	   }
	   var addhtml = "<input id='embedurl' name='embedurl' type='text' style='width:150px' onclick='javascript:document.getElementById(\"embedurl\").focus();document.getElementById(\"embedurl\").select();' value='<iframe width=\"475\" height=\"475\" frameborder=\"0\" scrolling=\"no\" marginheight=\"0\" marginwidth=\"0\" src=\"http://www.tripnaksha.com/index.php?option=com_trailembed&tview="+trailID+"&trailname="+trailName+"&tmpl=component&theight=475&twidth=475\"></iframe><br />'></div><br />";
/*	   var addhtml = "<input id='embedurl' name='embedurl' type='text' style='width:150px' onclick='javascript:document.getElementById(\"embedurl\").focus();document.getElementById(\"embedurl\").select();' value='<iframe width=\"475\" height=\"475\" frameborder=\"0\" scrolling=\"no\" marginheight=\"0\" marginwidth=\"0\" src=\"http://www.tripnaksha.com/index.php?option=com_trailembed&tview="+trailID+"&trailname="+trailName+"&tmpl=component&theight=475&twidth=475\"></iframe><div style=\"color:green;font-size:small\">Create your own route at <a href=\"http://www.tripnaksha.com\">TripNaksha</a></div>'></div><br />";
*/
	   addhtml = addhtml + "<div class='panellink'><a class='rightpanel' href='javascript:document.getElementById(\"imageurl\").focus();document.getElementById(\"imageurl\").select();' title='Copy the HTML code below and paste to your website'>Copy trail <b>image</b> to your website</a><br /><input id='imageurl' name='imageurl' type='text' style='width:150px' onclick='javascript:document.getElementById(\"imageurl\").focus();document.getElementById(\"imageurl\").select();' value='<img src=\"http://maps.google.com/maps/api/staticmap?size=475x475&amp;path=weight:3|color:red|enc:"+encodeurl+"&amp;sensor=false&amp;maptype=hybrid\" alt=\""+trailName+"\"/><div style=\"color:green;font-size:small\">Create your own route at <a href=\"www.tripnaksha.com\">TripNaksha</a></div>'><br />";
	   var map_addon = document.getElementById("map_addon");
	   map_addon.innerHTML = map_addon.innerHTML.replace("abcdefg", addhtml);
	}
    }
};
...
//	   disTrack = 0;
	...
	if (!city && searchBox.value.length == 0)
	{
	   alert ("Please enter all or part of the trail name which you want to find.");
	   searchBox.focus();
	}
...
//			var dropSelect = document.getElementById('dropZSelect');
//			var value = dropSelect.selectedIndex;
//			if (value!=0)
//			  zoomLevel = value;
			srchFlag = 1;
...
// alert (document.getElementById("tab0_content").innerHTML);
...
/*            var lblScript = document.createElement('script');
            lblScript.type = 'text/javascript';
            lblScript.src = rtLocation + "/js/labeledMarker.js";
 //           head.appendChild(lblScript);

            var xmlScript = document.createElement('script');
            xmlScript.type = 'text/javascript';
            xmlScript.src = rtLocation + "/js/xmlWriter.js";
//            head.appendChild(xmlScript);
            
            var extInfoWindow = document.createElement('script');
            extInfoWindow.type = 'text/javascript';
            extInfoWindow.src = rtLocation + "/js/extinfowindow.js";
//            head.appendChild(extInfoWindow);
*/            
	    ...
	    if (tid != 0)
	    {
	       ...
	       var map_addon = document.getElementById("map_addon");
	       var map_altmap = document.getElementById("map_altmap");
	       map = new GMap2(map_div,{size:new GSize(550,500)});
	       map_div.style.height = '500px';
	       map_div.style.width = '550px';
	       map_addon.style.width = '200px';
	       map_addon.style.height = '500px';
	       map_addon.style.borderLeft = '1px solid';
	       map_addon.style.visibility = 'visible';
/*	       map_altmap.style.border = '1px solid red';
	       map_altmap.style.height = '100px';
	       map_altmap.style.width = '750px';
	       map_altmap.style.visibility = 'visible';
*/	    }
	    else
...
//	       checkAddress (city);
	    ...
	    GEvent.addListener(gdir, "load", function() {
	       if (gdircomp == 1)
	       {
//		   pausecomp(gdir.getDuration().seconds+limit);
		   poly[polycnt] = gdir.getPolyline();
		   map.addOverlay(poly[polycnt]);
		   polycnt++;
		   gdircomp = 1;
//		   disTrack[] = gdir.getDistance().meters;
//                   disTrack[routeTrack.length - 1] = gdir.getDistance().meters;
		   distance = calcDistance();
		   var disLabel = document.getElementById("disStat");
		   if (disLabel)
		      disLabel.innerHTML = "Total distance - " + distance + "km";
