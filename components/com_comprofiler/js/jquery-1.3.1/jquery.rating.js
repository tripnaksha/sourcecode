...
/*# AVOID COLLISIONS #*/
	...
	$.fn.rating = function(instanceSettings){
		...
		this.each(function(i){
			...
			var n = $(this).parents('form').attr('name') + '___' + this.id +'_'+this.name;
			...
			if(i == 0){
				...
				$.rating.groups[n].valueElem = $('<input type="hidden" name="' + this.name + '" value=""' + (settings.readOnly ? ' disabled="disabled"' : '') + '/>');
