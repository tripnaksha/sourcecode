...
class EventListController extends JController
{
	...
	function display()
	{
		...
		// Must be logged in
		if ($user->get('id') < 1 && $view == 'editevent') {
			...
			printf("<div id='loadingimg'><img src='../com_traildisplay/images/indicator.gif' alt='loading' /></div><script type='text/javascript'>SqueezeBox.fromElement('index.php?option=com_login_box&login_only=1', {handler: 'iframe', size: {x: 400, y: 320}});</script>");
