...
//print_r($this->_data);
	...
	function _buildQuery()
	{
		...
		$query = 'SELECT a.id, a.dates, a.enddates, a.times, a.endtimes, a.title, a.locid, a.datdescription, a.created, l.name as venue, "" city, "" state, "" url, c.catname, c.id AS catid,'
...
//die($query);
	...
	function getVenue( )
	{
		//Location holen
		$query = 'SELECT *,'
				.' CASE WHEN CHAR_LENGTH(name) THEN CONCAT_WS(\':\', id, name) ELSE id END as slug'
				.' FROM #__trailList'
				.' WHERE id ='. $this->_id;
//die($query);
