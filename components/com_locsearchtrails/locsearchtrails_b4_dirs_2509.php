...
$db =& JFactory::getDBO();
		...
		{
			$part1 = "SELECT DISTINCT b.id, b.name, b.nname, b.nemail, b.routeXML, b.routeStart, b.mapCenter, \n" .
		...
		$part2 = "SELECT DISTINCT b.id, b.name, b.nname, b.nemail, b.routeXML, b.routeStart, b.mapCenter, \n" .
			" b.zoomLevel, b.userId, b.intro, b.length, DATE_FORMAT(b.createtime,'%d %b %y') as ttime, c.name as uname"  .
