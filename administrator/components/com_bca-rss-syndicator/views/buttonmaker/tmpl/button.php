...
if($save_file)
{
    $save_path =JPATH_ROOT .DS. "components".DS."com_bca-rss-syndicator".DS."assets".DS."images".DS."buttons";
    ...
    {
        exit('Image saved! link: <a href="'.JURI::root().'components/com_bca-rss-syndicator/assets/images/buttons/'.$img_name.'" title="'.$img_name.'">'.JURI::root().'components/com_bca-rss-syndicator/assets/images/buttons/'.$img_name.'</a>');
    }
    else
    {
