...
class bcarsssyndicatorModelConfig extends JModel
{
	...
	{
		$query = ' SELECT * FROM #__bcarsssyndicator '.
					'  WHERE id = 1 '
		;
	...
	function saveConfig(){
		...
		$renderAuthorFormat = JRequest::getVar('renderAuthorFormat', 'NAME', 'post', 'string');
		...
		$query = "UPDATE #__bcarsssyndicator SET msg = $msg,
