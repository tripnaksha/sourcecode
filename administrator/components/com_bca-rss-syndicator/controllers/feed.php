...
class BcaRssSyndicatorControllerFeed extends JController
{
	...
	{
		parent::__construct();
		$this->_link = 'index.php?option=com_bca-rss-syndicator&task=feeds';
	...
	function save()
	{
		...
		if($this->_task == 'apply')
		{
			...
			$this->_link = "index.php?option=com_bca-rss-syndicator&task=edit&cid[]=$id&controller=feed";
		}
