...
class EventListModelEvents extends JModel
{
	...
	function _buildQuery()
	{
		...
		$query = 'SELECT a.*, loc.name as venue, loc.name as city, 1 AS vchecked_out, cat.checked_out AS cchecked_out, cat.catname, u.email, u.name AS author'
					. ' FROM #__eventlist_events AS a'
					. ' LEFT JOIN #__trailList AS loc ON loc.id = a.locid'
