...
$mainframe->registerEvent( 'onDisplayTrails2', 'plgTrailTags2' );


class plgTrailTags2 extends JPlugin
{
	/**
	 * Constructor
	 *
	 ...
	 * @since 1.5
	 */
	function plgTrailTags2(& $subject, $config)
	{
